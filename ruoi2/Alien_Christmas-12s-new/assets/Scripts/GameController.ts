...
export default class GameController extends cc.Component {
    ...
    onLoad() {
        ...
        cc.audioEngine.playEffect(this.backgroundSound, true);
    }
    start() {
    }
    ...
    clickPopup() {
            if (cc.sys.os == cc.sys.OS_ANDROID) {
               cc.sys.openURL("https://play.google.com/store/apps/details?id=com.alienshooter.galaxy.attack2&hl=vi&gl=US");
            } else {
                cc.sys.openURL("https://apps.apple.com/us/app/galaxy-invaders-alien-shooter/id1449795053");
            }
        // mraid
        // mraid.open("dsds");
        // if (window["Mraid"]) {
    ...
    update() {
        ...
        if (window.matchMedia("(orientation: landscape)").matches) { 
            ...
            if (this.setPositionNgang==false) {
                //this.node = cc.find("Canvas/Ship")
                this.Ship.setPosition(8.808,-124.453)
